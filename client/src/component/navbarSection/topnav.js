...
export default function Topnav(props) {
  const { cartItems, userInfo, deleteCart, isDrawer, setDrawer } = useContext(
    CartContext
  );
        ...
        <HideOnScroll {...props}>
          <AppBar color="default" position="fixed" style={{ zIndex: "1201" }}>
            <Toolbar className="container">
              <strong className="white-text mr-2">Doggy</strong>
              {matches ? (
                <>
            ...
            {matches ? (
              <>
                <div
                  className={isExpanded ? "collapsed is-expanded" : "collapsed"}
                >
                  <NavLink
